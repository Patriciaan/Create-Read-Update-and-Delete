...
// Function to validate if a field is a positive number
...
if ($update) {
    $_SESSION['status'] = '<h2 style="color: white;">Record updated successfully</h2>';
    header('Location: index.php');
} else {
    $_SESSION['status'] = '<h2 style="color: white;">Record update failed</h2>';
    header('Location: index.php');
}
?>
